 ...
 ?>
      ...
      <div class="container">
        ...
        <section class="py-5">
          ...
          <div class="row">
            <div class="col-lg-8">
              <form action="function/add_user.php?action=website" method="post" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-lg-6 form-group">
                    <label class="text-small text-uppercase" for="firstName">name</label>
                    <input name="name" class="form-control form-control-lg" id="firstName" type="text" placeholder="Enter your name">
                  </div>
                  <div class="col-lg-6 form-group">
                  ...
                  <div class="col-lg-6 form-group">
                    ...
                    <input name="phone" class="form-control form-control-lg" id="phone" type="tel" placeholder="e.g. +02 245354745">
                  </div>
