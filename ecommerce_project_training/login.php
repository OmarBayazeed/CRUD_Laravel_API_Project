...
<div class="container">
  <form class="login" action="function/login_check.php" method="post">
    <h4 class="text-center">Login</h4>
    <input type="email" class="form-control input-lg" name="email" placeholder="Email" autocomplete="off">
