...
include "includes/header.php";
 ...
 <?php 
  ...
  $select = "SELECT * FROM product WHERE id = $pro_id";
          ...
          <div class="row mb-5">
              ...
              <div class="row m-sm-0">
                <div class="col-sm-2 p-sm-0 order-2 order-sm-1 mt-2 mt-sm-0">
                  <div class="owl-thumbs d-flex flex-row flex-sm-column" data-slider-id="1">
                    <div class="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0"><img class="w-100" src="admin/images/<?php echo $product['img'] ?>" alt="..."></div>
                    <div class="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0"><img class="w-100" src="admin/images/<?php echo $product['img'] ?>" alt="..."></div>
                    <div class="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0"><img class="w-100" src="admin/images/<?php echo $product['img'] ?>" alt="..."></div>
                    <div class="owl-thumb-item flex-fill mb-2"><img class="w-100" src="admin/images/<?php echo $product['img'] ?>" alt="..."></div>
                  </div>
                </div>
                <div class="col-sm-10 order-1 order-sm-2">
                  <div class="owl-carousel product-slider" data-slider-id="1"><a class="d-block" href="admin/images/<?php echo $product['img'] ?>" data-lightbox="product" title="Product item 1"><img class="img-fluid" src="admin/images/<?php echo $product['img'] ?>" alt="..."></a><a class="d-block" href="admin/images/<?php echo $product['img'] ?>" data-lightbox="product" title="Product item 2"><img class="img-fluid" src="admin/images/<?php echo $product['img'] ?>" alt="..."></a><a class="d-block" href="admin/images/<?php echo $product['img'] ?>" data-lightbox="product" title="Product item 3"><img class="img-fluid" src="admin/images/<?php echo $product['img'] ?>" alt="..."></a><a class="d-block" href="admin/images/<?php echo $product['img'] ?>" data-lightbox="product" title="Product item 4"><img class="img-fluid" src="admin/images/<?php echo $product['img'] ?>" alt="..."></a></div>
                </div>
              </div>
            </div>
            <!-- PRODUCT DETAILS-->
            <div class="col-lg-6">
              ...
              <ul class="list-unstyled small d-inline-block">
                ...
                <li class="px-3 py-2 mb-1 bg-white text-muted"><strong class="text-uppercase text-dark">Category:</strong><a class="reset-anchor ml-2" href="#"><?php echo $category['name'] ?></a></li>
