              ...
              <ul class="navbar-nav ml-auto">               
                ...
                <?php 
                  ...
                  ?>
                    ...
                    <li class="nav-item"><a class="nav-link"><i class="fas fa-user-alt mr-1 text-gray"></i><?php echo "hello" . " " . $_SESSION['username2']?></a></li>

                  <?php }elseif (isset($_SESSION['registered_user'])) { ?>

                    <li class="nav-item"><a class="nav-link"><i class="fas fa-user-alt mr-1 text-gray"></i><?php echo "hello" . " " . $_SESSION['registered_user_name']?></a></li>
                ...
                <li class="nav-item"><a class="nav-link" href="signup.php"> <i class="fas fa-user-alt mr-1 text-gray"></i>SignUp</a></li>
                <li class="nav-item">
