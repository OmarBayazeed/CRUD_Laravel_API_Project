 ...
 ?>
  ...
  <?php  
        if (isset($_SESSION['login_succesful2']) or isset($_SESSION['registered_user'])) {}
            ...
            echo "<script>alert('you should login first');window.location.href='index.php'</script>";
        }
        ?>
...
<?php 
                  ...
                  $pro_id = $cart['pro_id'];
                  $select_cart2 = "SELECT * FROM product WHERE id = $pro_id ";
                  $query2 = $conn -> query($select_cart2);
                  $product = $query2 -> fetch_assoc();
...
?> 
                    <tr>
                      <th class="pl-0 border-0" scope="row">
                        <div class="media align-items-center"><a class="reset-anchor d-block animsition-link" href="detail.php"><img src="admin/images/<?php echo $product['img'] ?>" alt="..." width="70"/></a>
                          <div class="media-body ml-3"><strong class="h6"><a class="reset-anchor animsition-link" href="detail.php"><?php echo $product['name'] ?></a></strong></div>
                        </div>
                      </th>
                      ...
                      <td class="align-middle border-0"><a class="reset-anchor" href="function/delete_cart.php?id=<?php echo $product['id'] ?>"><i class="fas fa-trash-alt small text-muted"></i></a></td>
                    </tr>
                    <?php } ?>
                  </tbody>
                </table>
