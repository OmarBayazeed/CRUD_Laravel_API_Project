                        ...
                        <li class="pr-cart-item">
							...
							<div class="quantity">
								<div class="quantity-input">
									<input type="text" name="product-quatity" value="{{$item->qty}}" max="{{$item->model->quantity}}" pattern="[0-9]*" >
				...
				<div class="summary">
					<div class="order-summary">
                        ...
                        @if (Session::has('coupon'))
                            ...
                            <p class="summary-info"><span class="title">Subtotal after Discount</span><b class="index">${{number_format(
                                $subtotalAfterDiscount,2)}}</b></p>
					...
					<div class="checkout-info">
                        @if (!Session::has('coupon'))
                            <label class="checkbox-field">
                                <input class="frm-input " name="have-code" id="have-code" value="1" wire:model='haveCoupon' type="checkbox"><span>I have Coupon Code</span>
                            </label>
                            @if ($haveCoupon == 1)
                                <br><br>
