                            ...
                            <div class="wrap-address-billing">
                                ...
                                <div class="billing-address">
                                    ...
                                    <p class="row-in-form">
                                        ...
                                        <input id="add" type="text" name="Line1" value="" placeholder="Street at apartment number" wire:model='line1'>
                                        @error('line1') <span class="text-danger">{{$message}}</span> @enderror
                                    </p>
                                    <p class="row-in-form">
                                        <label for="add">Line2:</label>
                                        <input id="add" type="text" name="Line2" value="" placeholder="Street at apartment number" wire:model='line2'>
                                    </p>
                                    <p class="row-in-form">
                                    ...
                                    <p class="row-in-form">
                                        ...
                                        <input id="city" type="text" name="province" value="" placeholder="Province" wire:model='province'>
                            ...
                            <div class="col-md-12">
                                <div class="wrap-address-billing">
                                    ...
                                    <div class="billing-address">
                                        ...
                                        <p class="row-in-form">
                                            <label for="add">Line1:</label>
                                            <input id="add" type="text" name="Line1" value="" placeholder="Street at apartment number" wire:model='s_line1'>
                                            @error('s_line1') <span class="text-danger">{{$message}}</span> @enderror
                                        </p>
                                        <p class="row-in-form">
                                            <label for="add">Line2:</label>
                                            <input id="add" type="text" name="Line2" value="" placeholder="Street at apartment number" wire:model='s_line2'>
                                        </p>
                                        <p class="row-in-form">
                                            <label for="country">Country<span>*</span></label>
                                        ...
                                        <p class="row-in-form">
                                            <label for="city">Province<span>*</span></label>
                                            <input id="city" type="text" name="Province" value="" placeholder="Province" wire:model='s_province'>
                        ...
                        <div class="summary-item payment-method">
                            ...
                            <div class="wrap-address-billing">
                                <p class="row-in-form">
                                    ...
                                    <input id="card-no" type="text" name="card-no" value="" placeholder="Card Number" wire:model='s_zipcode'>
                                    @error('s_zipcode') <span class="text-danger">{{$message}}</span> @enderror
                                </p>
                            </div>
