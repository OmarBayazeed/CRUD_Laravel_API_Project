                                        ...
                                        <div class="product product-widget-style">
                                            ...
                                            <div class="product-info">
                                                ...
                                                @if ($p_product->sale_price > 0 && $sale->status == 1 && $sale->sale_date > Carbon\Carbon::now())
                                                    <div class="wrap-price">
                                                        <span class="product-price">$ {{$p_product->sale_price}}</span>
                                                        <del><span class="product-price regprice">$ {{$p_product->regular_price}}</span></del>
                                                    </div>
                                                @else
                                    ...
                                    <div class="product product-style-2 equal-elem ">
                                        ...
                                        <div class="product-info">
                                            ...
                                            @if ($r_product->sale_price > 0 && $sale->status == 1 && $sale->sale_date > Carbon\Carbon::now())
                                                <div class="wrap-price">
                                                    <span class="product-price">$ {{$r_product->sale_price}}</span>
                                                    <del><span class="product-price regprice">$ {{$r_product->regular_price}}</span></del>
                                                </div>
                                            @else
