                                ...
                                <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                                    <div class="product product-style-3 equal-elem ">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="wrap-price"><ins><span class="product-price" style="color: red">${{$product->sale_price}}</span></ins> <del><p class="product-price regprice">${{$product->regular_price}}</p></del></div>
                                            @else
                                            ...
                                            <div class="product-wish">
                                                @if ($witems->contains($product->id))
                                                    <a href="javascript:void(0);" wire:click.prevent='removeFromWishlist({{$product->id}})'><i class="fa fa-heart fill-heart"></i></a>
                                                @else
                                                    <a href="javascript:void(0);" wire:click.prevent="addToWishlist({{$product->id}},'{{$product->name}}',{{$product->regular_price}})"><i class="fa fa-heart"></i></a>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
