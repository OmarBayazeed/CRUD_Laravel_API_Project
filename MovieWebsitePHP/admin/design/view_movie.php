...
<div class="container">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="index.php">Movies in category : <?php echo $_GET['category_name'] ?></a>
...
<div class="container">
  ...
  <div class="row">
    <?php 
          ...
          $select_movie = "SELECT * FROM movie WHERE category_id = $id1";
